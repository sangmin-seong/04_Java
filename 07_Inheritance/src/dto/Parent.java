 ...
 *   작성되어 있지 않으면, 컴파일러가 extends Object 구문을 추가해줌 
 */
...
public class Parent extends Object{
	...
	// 기본생성자
	public Parent() {
		System.out.println("부모 - 기본생성자로 객체 생성");
	}
	 ...
	 * 
	 * - 오버라이딩 불가
	 *   -> 부모의 메서드가 완벽해서 또는 재정의하면 문제되서
	 *      더이상 오버라이딩을 못하게 하겠다
	 *      (마지막으로 정의된 메서드)
	 * 
	 * - public final 반환형 메서드(){}
	 */
