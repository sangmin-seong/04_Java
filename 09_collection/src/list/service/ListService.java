...
/* Collection Framework : 자바에서 제공하는  자료구조를 모아둔 것
 * (java.util 패키지에 존재)
 * 
 * [특징]
 * 1) 크기 제한X
 * 2) 추가, 수정, 삭제, 검색, 정력 등 다양한 기능 제공됨
 * 3) 객체만 저장 가능!!
...
public class ListService {
	...
	public void test1() {
		...
		// E(Element) : 요소를 뜻하는 상직적인 글자(자료형X)
		...
		System.out.println("현재 저장된 데이터 개수 : " + list.size());
	...
	public void test2() {
		...
		*/
		...
		//add() 확인
//		menuList.add(123); // String 으로 제한되어 다른 자료형 추가 불가
		menuList.add("짬뽕");
		menuList.add("짜장");
		menuList.add("순두부");
		menuList.add("삼겹살");
		...
		System.out.println("쌀국수" + menuList.contains("쌀국수"));
		
		// 7. int indexOf(E e)
		// - List 내부에 e와 같은 객체가
		//   존재하면 해당 인덱스 반환, 존재하지 않으면 -1을 반환
