...
public class PrintEx {
	...
	public static void main(String[] args) {
		...
		// print(), println()
		System.out.print("이름 :"); // 줄 바꿈 X
		System.out.println("성상민"); // 줄 바꿈 O
		System.out.println("와 자바 재밌다......"); // 줄 바꿈 O
		...
		// 홍길동은 25세 남성으로 키는 212.5cm 이고, 자바 공부여부 : true 이다
		...
		// printf() 버전
		System.out.printf("%s은 %d세 %c성으로 키는 %fcm 이고, 자바 공부여부 : %b 이다", 
