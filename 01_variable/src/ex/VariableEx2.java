...
public class VariableEx2 {
	...
	public static void main(String[] args) {
		 ...
		 *    컴파일러가 자동으로 범위가 작은 갑을 큰 값의 자료형으로 변환
		 * */
		
		System.out.println("자동 현변환 예시");
		...
		//999+10000000000L
		//=> 999L +10000000000L = 10000000000L(long)
		// double result3 = 10000000999L(long)
		// -> double result3 = 10000000999(double)
		double result3 = num3a+num3b;
		System.out.println(result3); //1.0000000999E10
		...
		//int result = a + b; // a + b = 123.4(double)
