...
public class VariableEx3 {
	...
	public static void main(String[] args) {
		...
		// 자동 형변환
		System.out.println(num2-result2); // 0.45678900000000056 (2진수로 소수표현 시 문제점)
		...
		System.out.println("성의 번호 : "+ (int)'성'); // 49457
		System.out.println("상의 번호 : "+ (int)'상'); // 49345
		System.out.println("민의 번호 : "+ (int)'민'); // 48124
		
		System.out.println("ㄱ 번호 : "+ (int)'ㄱ'); // 12593
		System.out.println("ㄱ 다음 : "+ (char)('ㄱ' + 1)); // ㄲ 
		System.out.println("ㄱ 다음 : "+ (char)('ㄱ' + 2)); // ㄳ
		System.out.println("ㄱ 다음 : "+ (char)('ㄱ' + 3)); // ㄴ
