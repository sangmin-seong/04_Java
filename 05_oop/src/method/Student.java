...
public class Student {
	...
	// 클래스명.변수명형태로 호출하기 때문에 class 변수  // ex) Student.schoolName
	...
	/* 생성자 */
	// - new연산자에 의해 객체 생성 시 실행되는 메서드(기능)
	...
	public String toString() {
		...
		// (printf와 비슷, printf는 출력, 
		// String.fomat()은 문자열만들어서 반환)
